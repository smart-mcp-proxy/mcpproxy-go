...
graph LR
  ...
  classDef in_progress fill:#1f6feb,stroke:#0b3d91,color:#ffffff;
  class sso_pr_a_freeze_cut,sso_pr_b_oidc_front_door,sso_pr_c_group_allowlist,sso_pr_d_audit_line in_progress;
```
...
| PR-D attributable JSONL audit line + auth_event + config/doctor/metrics (US3) | 🔵 In progress | #1296 |
