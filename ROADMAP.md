...
| Planning/docs truth automation | In progress | P2 | — |  |  |
| Spec 107 server edition SSO front door hardened for real IdPs | In progress | P2 | 4/126 (3%) | [107-server-edition-sso-hardening](./specs/107-server-edition-sso-hardening/) |  |
...
| [107-server-edition-sso-hardening](./specs/107-server-edition-sso-hardening/) | `in-flight` | 4/126 (3%) |
