...
| Agent-token scope hardening: every MCP request authorized by its own scope (spec 105) | In progress | P1 | 6/109 (6%) | [105-agent-scope-hardening](./specs/105-agent-scope-hardening/) |  |
...
| [105-agent-scope-hardening](./specs/105-agent-scope-hardening/) | `in-flight` | 6/109 (6%) |
