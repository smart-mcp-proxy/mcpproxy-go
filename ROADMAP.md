...
graph LR
  ...
  classDef in_progress fill:#1f6feb,stroke:#0b3d91,color:#ffffff;
  classDef todo fill:#6e7781,stroke:#3d4248,color:#ffffff;
  class sso_pr_a_freeze_cut,sso_pr_b_oidc_front_door,sso_pr_c_group_allowlist in_progress;
...
| Planning/docs truth automation | In progress | P2 | — |  |  |
| Spec 107 server edition SSO front door hardened for real IdPs | In progress | P2 | 102/126 (81%) | [107-server-edition-sso-hardening](./specs/107-server-edition-sso-hardening/) |  |
