...
// question, "is this server Docker-isolated at all", is NOT mirrored: both
// supervisor.usesDockerIsolation and managed.Client.IsDockerIsolated delegate to
// config.ResolveIsolation, the resolver the spawn path branches on.) Unknown commands
